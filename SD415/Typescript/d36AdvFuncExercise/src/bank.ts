...
type CustomerRecord = {customerId:number; customerTransactions:number[]}[];
type Bank ={getBalance:(customerID:number)=>number;bankBalance:()=>number};

export  function makeBank():Bank{

     let transactionsDB : CustomerRecord = [{ customerId: 1, customerTransactions: [10, 50, -40] },
